...
const COMMON_AGGREGATED_ACTIVE_HEADERS: CommonAggregatedActives = (
    ...
    { header: 'Оценка имущества, ₽',                    key: `amounts.active.${type}.evaluation`,        numFmt: '#,##0.00' },
    { header: 'Принудительная реализация, ₽',           key: `amounts.active.${type}.realizationFirst`,  numFmt: '#,##0.00' },
    { header: 'Торги 2 этап, ₽',                        key: `amounts.active.${type}.realizationSecond`, numFmt: '#,##0.00' },
    { header: 'Результат принудительной реализации, ₽', key: `amounts.active.${type}.realizationResult`, numFmt: '#,##0.00' },
