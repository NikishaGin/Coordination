...
LEFT JOIN (SELECT
        ...
        SUM(IFNULL(realization_sum_1, 0.00)) as realization_property_tr,
...
LEFT JOIN (SELECT
        ...
        SUM(IFNULL(realization_sum_1, 0.00)) as realization_property_nedv,
...
LEFT JOIN (SELECT
        ...
        SUM(IFNULL(realization_sum_1, 0.00)) as realization_property_debit,
...
LEFT JOIN (SELECT
        ...
        SUM(IFNULL(realization_sum_1, 0.00)) as realization_property_another,
